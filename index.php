	...
	<div class="main-navigation navbar-fixed-top">
		<nav class="navbar navbar-default">
			...
			<div class="navbar-header">
			  ...
			  <a class="navbar-brand" href="index.php">MAGNOLIA</a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
			  <ul class="nav navbar-nav navbar-right">
			    <li id="home" class="active" ><a href="#banner">HOME</a></li>
			    <li id="about"><a href="#about">ABOUT</a></li>
			    <li id="category"><a href="#category">CATEGORY</a></li>
			    <li id="sign"><a href="#sign">ACCOUNT</a></li>
			...
			<div style="visibility: visible; animation-name: zoomIn;" class="col-md-12 text-center wow zoomIn">
				<div class="footer_copyright">
					...
					<div class="credits">
                        ...
                        -->
                        Designed by <a href="https://bootstrapmade.com/">MagnoliaGroup</a>
                    </div>
				</div>
			</div>
		</div>
